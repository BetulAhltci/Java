...
public class C03_StringBuilder {
    public static void main(String[] args) {
        ...
        //StringBuilder metin eşitliğini sorgulamak için equals kullanmaz
        ...
        //System.out.println(sb1==str); data türleri farklı CTE verir

        System.out.println(sb1.equals(str));//false

       // System.out.println(sb1.compareTo(str)); compareTo StringBuilder için çalışır farklı data türükabul etmez
