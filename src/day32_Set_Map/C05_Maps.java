...
public class C05_Maps {
    public static void main(String[] args) {
        ...
        ogrenciMap.put(103,"Ali-Cem-10-H-MF");
        ogrenciMap.put(104,"Ayse-Can-10-H-MF");

        System.out.println(ogrenciMap);
        //{101=Ali-Can-11-H-MF, 102=Veli-cem-10-K-TM, 103=Ali-Cem-10-H-MF, 104=Ayse-Can-10-H-MF}

        System.out.println(ogrenciMap.size());//4

        //map'de 103 numaralı ogrencı varmı
        System.out.println(ogrenciMap.containsKey(103));//true

        //Ali isminde öğrenci varmı
