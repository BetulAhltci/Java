...
public class C06_TreeMapMethodları {
    public static void main(String[] args) {
        ...
        System.out.println(harfSayilariMap.lowerKey("E"));//D eden kücük en büyük değer
        ...
        System.out.println(harfSayilariMap.higherKey("D"));//K D den büyük en kücük
        System.out.println(harfSayilariMap.ceilingKey("D"));//D

        System.out.println(harfSayilariMap);//{A=10, C=15, D=3, K=5}

        System.out.println(harfSayilariMap.headMap("D"));//{A=10, C=15} D den başa dogru d bitiş dahil değil
        System.out.println(harfSayilariMap.headMap("D",true));//{A=10, C=15, D=3}

        System.out.println(harfSayilariMap.tailMap("C"));//{C=15, D=3, K=5} C den kuyruga doğru c baslangıc dahil
